...
import 'edit_ingredients_list_widget.dart';
import 'edit_instructions_list_widget.dart';
import 'edit_recipe_menu.dart';
                  ...
                  TextButton(
                    onPressed: (() async {
                      ...
                      final RecipeModel updatedRecipe = widget.recipeData
                          .copyWith(
                              name: widget._titleController.text.trim());
                      await widget.ref
                          .read(recipeFromUrlProvider.notifier)
                          .updateRecipe(
                              key: widget.recipeData.id,
