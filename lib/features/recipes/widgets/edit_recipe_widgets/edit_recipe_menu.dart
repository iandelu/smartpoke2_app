...
import 'edit_recipe_bottom_sheet_widget.dart';
    ...
    return recipe.maybeWhen(
      ...
      data: (data) {
        if (data.isEmpty) {
          ...
          final recipeData =
              data.where((RecipeModel element) => element.id == widget.recipe.id).first;
          seperatedInstructions.addAll(recipeData.recipeSteps.map((e) => e.description).toList());
          ...
          return PullDownButton(
              itemBuilder: ((context) => [
                          ...
                          showModalBottomSheet(
                              ...
                              builder: ((context) {
                                List<String> extendedIngredientsCopy =
                                    recipeData.recipeSteps.map((e) => e.description).toList();
                    ...
                    PullDownMenuItem(
                        onTap: () {
                          launchHelperMethod(Uri.parse(widget.recipe.source));
                        },
                        title: 'Visit Source',
